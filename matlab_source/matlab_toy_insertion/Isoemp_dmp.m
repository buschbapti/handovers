                ...
                if flagClean ~= 0
                   if plotRollOuts
                    ...
                    if 1 % this plots the reference trajectory
                        ...
                        param.pathPlotStyle    = struct('LineWidth', 2, 'Color', 'b', 'Marker', 'none');
                        param.axesPlotStyle{1} = struct('LineWidth', 2, 'Color', [0.5 .5 .5]);
                        param.axesPlotStyle{2} = struct('LineWidth', 2, 'Color', [0.5 .5 .5]);
                        param.axesPlotStyle{3} = struct('LineWidth', 2, 'Color', [0.5 .5 .5]);                        
                        homogTransfPlot(Tnew(:,:,end), param);                        
                    end
